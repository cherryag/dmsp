%% Spectral Leakage Corrector using b1_agg
% Version July 2018
% UPDATED: 12/12/2019

% copied b1_agg spectral leakage correction from
% MultipleExpAggregated_DataLoader_2.m

clear all;

analysis = uigetdir; % where analysis .mat are located
load([analysis,'/06_FluoCellComputation_analysisonly.mat']);

saveplace = [analysis,'/leakage figures']; mkdir(saveplace);
...
% load aggregated b1
load('/Volumes/Latte 4TB/_DMSPAvailabilityHypothesis_Datasets/aggregated_b1/all expts_b1 final_copied_to_desktop_2019-08-05/RegressionSlope_b1_aggregated.mat')
...
save(strcat(analysis,'/09_SpectralLeakageCorrector.mat'))
